...
<%-- 	<%@include file="/html/header.html"%> --%>
	...
	<div class="container-fluid">
		<h1
			style="margin: 50px; margin-left: 65%; font-family: cursive; color: white; font-size: 50px; text-shadow: 10px 10px 5px lightblue">Admin
			Login Here</h1>
	</div>
		...
		<form action="/SportsAcademy/AdminLogin" method="post"
			...
			<div class="form-floating my-4">
				<input type="text" class="form-control" placeholder="Enter Your ID"
					name="adminId" required="required"> <label for="id">Admin
					ID</label>
				<div class="invalid-feedback">Please enter a your ID.</div>
			...
			<div class="form-floating mb-4">
				<input type="password" class="form-control"
					placeholder="Enter Your Password" name="adminPass"
