...
public class AdminDao {
	...
	public ArrayList<Notice> viewNotices(){
		...
		// limit 10 => used to show only 10 notices from table on the basis of date(descending order)
...
public ArrayList<FeedBack> viewFeedback() {
	...
	public int deleteContact(String[] idArray) {
		...
		//		int x = ps.executeUpdate();//  go to DBMS for single Query and if we have multiple data then
